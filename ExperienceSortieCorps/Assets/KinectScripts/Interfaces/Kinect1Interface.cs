...
//			KinectInterop.CopyResourceFile(sTargetPath + "FaceTrackData.dll", "FaceTrackData.dll", ref bOneCopied, ref bAllCopied);
//			KinectInterop.CopyResourceFile(sTargetPath + "KinectUnityWrapper.dll", "KinectUnityWrapper.dll", ref bOneCopied, ref bAllCopied);
//			KinectInterop.CopyResourceFile(sTargetPath + "KinectInteraction180_32.dll", "KinectInteraction180_32.dll", ref bOneCopied, ref bAllCopied);
//			KinectInterop.CopyResourceFile(sTargetPath + "FaceTrackLib.dll", "FaceTrackLib.dll", ref bOneCopied, ref bAllCopied);
//			KinectInterop.CopyResourceFile(sTargetPath + "KinectBackgroundRemoval180_32.dll", "KinectBackgroundRemoval180_32.dll", ref bOneCopied, ref bAllCopied);
//
//			KinectInterop.CopyResourceFile(sTargetPath + "msvcp100d.dll", "msvcp100d.dll", ref bOneCopied, ref bAllCopied);
//			KinectInterop.CopyResourceFile(sTargetPath + "msvcr100d.dll", "msvcr100d.dll", ref bOneCopied, ref bAllCopied);
			...
			KinectInterop.UnzipResourceFiles(dictFilesToUnzip, "FaceTrackData.zip", ref bOneCopied, ref bAllCopied);
...
//			KinectInterop.CopyResourceFile(sTargetPath + "FaceTrackData.dll", "FaceTrackData.dll", ref bOneCopied, ref bAllCopied); // use the same data-dll
//			KinectInterop.CopyResourceFile(sTargetPath + "KinectUnityWrapper.dll", "KinectUnityWrapper.dll.x64", ref bOneCopied, ref bAllCopied);
//			KinectInterop.CopyResourceFile(sTargetPath + "KinectInteraction180_64.dll", "KinectInteraction180_64.dll.x64", ref bOneCopied, ref bAllCopied);
//			KinectInterop.CopyResourceFile(sTargetPath + "FaceTrackLib.dll", "FaceTrackLib.dll.x64", ref bOneCopied, ref bAllCopied);
//			KinectInterop.CopyResourceFile(sTargetPath + "KinectBackgroundRemoval180_64.dll", "KinectBackgroundRemoval180_64.dll.x64", ref bOneCopied, ref bAllCopied);
//
//			KinectInterop.CopyResourceFile(sTargetPath + "msvcp100d.dll", "msvcp100d.dll.x64", ref bOneCopied, ref bAllCopied);
//			KinectInterop.CopyResourceFile(sTargetPath + "msvcr100d.dll", "msvcr100d.dll.x64", ref bOneCopied, ref bAllCopied);

...
public class BoneOrientationsConstraint
{
    ...
    public void AddDefaultConstraints()
    {
		...
		AddBoneOrientationConstraint((int)KinectInterop.JointType.ElbowLeft, ConstraintAxis.Y, 0f, 140f);  // sag
		...
		AddBoneOrientationConstraint((int)KinectInterop.JointType.ElbowRight, ConstraintAxis.Y, -140f, 0f);  // sag
		...
		//AddBoneOrientationConstraint((int)KinectInterop.JointType.WristLeft, ConstraintAxis.Y, -15f, 45f);  // sag
		AddBoneOrientationConstraint((int)KinectInterop.JointType.WristLeft, ConstraintAxis.Z, -85f, 85f);  // lat
		AddBoneOrientationConstraint((int)KinectInterop.JointType.WristRight, ConstraintAxis.X, -90f, 90f);  // rot
		//AddBoneOrientationConstraint((int)KinectInterop.JointType.WristRight, ConstraintAxis.Y, -45f, 15f);  // sag
		AddBoneOrientationConstraint((int)KinectInterop.JointType.WristRight, ConstraintAxis.Z, -85f, 85f);  // lat
		...
		// HipLeft, HipRight
		AddBoneOrientationConstraint((int)KinectInterop.JointType.HipLeft, ConstraintAxis.X, -110f, 30f);
		AddBoneOrientationConstraint((int)KinectInterop.JointType.HipLeft, ConstraintAxis.Y, -5f, 5f);
		AddBoneOrientationConstraint((int)KinectInterop.JointType.HipLeft, ConstraintAxis.Z, -90f, 30f);
		AddBoneOrientationConstraint((int)KinectInterop.JointType.HipRight, ConstraintAxis.X, -110f, 30f);
		AddBoneOrientationConstraint((int)KinectInterop.JointType.HipRight, ConstraintAxis.Y, -5f, 5f);
		AddBoneOrientationConstraint((int)KinectInterop.JointType.HipRight, ConstraintAxis.Z, -30f, 90f);
		
		// KneeLeft, KneeRight
		AddBoneOrientationConstraint((int)KinectInterop.JointType.KneeLeft, ConstraintAxis.X, 0f, 90f);
		AddBoneOrientationConstraint((int)KinectInterop.JointType.KneeLeft, ConstraintAxis.Y, -5f, 5f);
		AddBoneOrientationConstraint((int)KinectInterop.JointType.KneeLeft, ConstraintAxis.Z, -5f, 5f);
		AddBoneOrientationConstraint((int)KinectInterop.JointType.KneeRight, ConstraintAxis.X, 0f, 90f);
		AddBoneOrientationConstraint((int)KinectInterop.JointType.KneeRight, ConstraintAxis.Y, -5f, 5f);
		AddBoneOrientationConstraint((int)KinectInterop.JointType.KneeRight, ConstraintAxis.Z, -5f, 5f);

		// AnkleLeft, AnkleRight
		AddBoneOrientationConstraint((int)KinectInterop.JointType.AnkleLeft, ConstraintAxis.X, -20f, 20f);
		AddBoneOrientationConstraint((int)KinectInterop.JointType.AnkleLeft, ConstraintAxis.Y, -20f, 20f);
		AddBoneOrientationConstraint((int)KinectInterop.JointType.AnkleLeft, ConstraintAxis.Z, -5f, 5f);
		AddBoneOrientationConstraint((int)KinectInterop.JointType.AnkleRight, ConstraintAxis.X, -20f, 20f);
		AddBoneOrientationConstraint((int)KinectInterop.JointType.AnkleRight, ConstraintAxis.Y, -20f, 20f);
		AddBoneOrientationConstraint((int)KinectInterop.JointType.AnkleRight, ConstraintAxis.Z, -5f, 5f);
	}
